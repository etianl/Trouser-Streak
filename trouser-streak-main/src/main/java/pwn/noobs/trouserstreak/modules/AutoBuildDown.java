...
public class AutoBuildDown extends Module {
    ...
    public AutoBuildDown() {
        super(Trouser.Main, "auto-build-down", "Build whatever you draw. (Beneath your feet and front of you)");
    }
    ...
    private List<BlockPos> placePos() {
        ...
        if (dir == Direction.SOUTH){
            ...
            a = 0; b = 1; ab = 2; ba = 3; c = 4;
        }
        else if (dir == Direction.WEST) {
            x = -0; y = -1; xy = -2; yx = -3; z = -4;
        ...
        if (ett) add(pos, playerPos.add(x , -5, a));
        if (tva) add(pos, playerPos.add(y, -5, b));
        if (tree) add(pos, playerPos.add(xy, -5, ab));
        if (fyra) add(pos, playerPos.add(yx , -5,  ba));
        if (fem) add(pos, playerPos.add(z, -5, c));

        if (ett1) add(pos, playerPos.add(x , -4, a));
        if (tva1) add(pos, playerPos.add(y, -4, b));
        if (tree1) add(pos, playerPos.add(xy, -4, ab));
        if (fyra1) add(pos, playerPos.add(yx , -4,  ba));
        if (fem1) add(pos, playerPos.add(z, -4, c));

        if (ett2) add(pos, playerPos.add(x , -3, a));
        if (tva2) add(pos, playerPos.add(y, -3, b));
        if (tree2) add(pos, playerPos.add(xy, -3, ab));
        if (fyra2) add(pos, playerPos.add(yx , -3,  ba));
        if (fem2) add(pos, playerPos.add(z, -3, c));

        if (ett3) add(pos, playerPos.add(x , -2, a));
        if (tva3) add(pos, playerPos.add(y, -2, b));
        if (tree3) add(pos, playerPos.add(xy, -2, ab));
        if (fyra3) add(pos, playerPos.add(yx , -2,  ba));
        if (fem3) add(pos, playerPos.add(z, -2, c));

        if (ett4) add(pos, playerPos.add(x , -1, a));
        if (tva4) add(pos, playerPos.add(y, -1, b));
        if (tree4) add(pos, playerPos.add(xy, -1, ab));
        if (fyra4) add(pos, playerPos.add(yx , -1,  ba));
        if (fem4) add(pos, playerPos.add(z, -1, c));
