...
public class StorageLooter extends Module {
    ...
    private int getItemScore(ItemStack stack) {
        ...
        if (stack.getItem() instanceof ArmorItem) {
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.PROTECTION) * 10;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.BLAST_PROTECTION) * 10;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.FIRE_PROTECTION) * 10;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.PROJECTILE_PROTECTION) * 10;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.UNBREAKING) * 9;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.MENDING) * 8;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.THORNS) * 5;
        } else if (stack.getItem() instanceof SwordItem) {
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.SMITE) * 10;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.SHARPNESS) * 10;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.BANE_OF_ARTHROPODS) * 9;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.FIRE_ASPECT) * 9;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.UNBREAKING) * 9;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.MENDING) * 8;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.LOOTING) * 5;
        } else if (stack.getItem() instanceof ToolItem) {
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.EFFICIENCY) * 10;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.UNBREAKING) * 9;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.MENDING) * 8;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.SILK_TOUCH) * 6;
            enchantmentscore += getEnchantmentLevel(enchantments, Enchantments.FORTUNE) * 5;
        }
    ...
    private int getEnchantmentLevel(ItemEnchantmentsComponent enchantments, Enchantment enchantment) {
