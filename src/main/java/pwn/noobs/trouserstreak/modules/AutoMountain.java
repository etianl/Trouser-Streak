...
public class AutoMountain extends Module {
    ...
    private final Setting<Integer> limit = sgBuild.add(new IntSetting.Builder()
            ...
            .defaultValue(318)
            .build());
    public final Setting<Boolean> InvertDir = sgBuild.add(new BoolSetting.Builder()
    ...
    private final Setting<Double> lag = sgTimings.add(new DoubleSetting.Builder()
            ...
            .build());
    private final Setting<Boolean> adeathonoff = sgGeneral.add(new BoolSetting.Builder()
            .name("RubberBandAntiDeath")
            .description("Prevents death if rubberbanding when clicking to pause while building downward by freezing your velocity.")
            .defaultValue(false)
            .build()
    );
    private final Setting<Double> antideath = sgGeneral.add(new DoubleSetting.Builder()
            .name("AntiDeathTimerInTicks")
            .description("How long to freeze your velocity to prevent death by rubberband when pausing and building down.")
            .sliderRange(0, 60)
            .defaultValue(30)
            .visible(() -> adeathonoff.get())
            .build());
    ...
    private void onPreTick(TickEvent.Pre event) {
        ...
        ticks++;
        if (!pause == true) {
            if (adeathonoff.get() && pitchonPause >= 40){
    ...
    public void onPlayerMove(PlayerMoveEvent playerMoveEvent) {
        ...
        if (delayLeft > 0) delayLeft--;
        ...
        else if ((!lagpause.get() || timeSinceLastTick <= lag.get()) && mc.player.getY() <= limit.get() && delayLeft <= 0 && offLeft > 0 && pause==true) {
            offLeft--;
            ...
            switch (mc.player.getMovementDirection()) {
                case NORTH -> {
                    ...
                    if (!mc.world.getBlockState(un1).getMaterial().isSolid() && !mc.world.getBlockState(un2).getMaterial().isSolid() && !mc.world.getBlockState(un3).getMaterial().isSolid() && !mc.world.getBlockState(un1).getMaterial().isLiquid() && !mc.world.getBlockState(un2).getMaterial().isLiquid() && !mc.world.getBlockState(un3).getMaterial().isLiquid() && !mc.world.getBlockState(un1).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(un2).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(un3).getMaterial().equals(Material.POWDER_SNOW)){
                ...
                case EAST -> {
                    ...
                    if (!mc.world.getBlockState(ue1).getMaterial().isSolid() && !mc.world.getBlockState(ue2).getMaterial().isSolid() && !mc.world.getBlockState(ue3).getMaterial().isSolid() && !mc.world.getBlockState(ue1).getMaterial().isLiquid() && !mc.world.getBlockState(ue2).getMaterial().isLiquid() && !mc.world.getBlockState(ue3).getMaterial().isLiquid() && !mc.world.getBlockState(ue1).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(ue2).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(ue3).getMaterial().equals(Material.POWDER_SNOW)){
                ...
                case SOUTH -> {
                    ...
                    if (!mc.world.getBlockState(us1).getMaterial().isSolid() && !mc.world.getBlockState(us2).getMaterial().isSolid() && !mc.world.getBlockState(us3).getMaterial().isSolid() && !mc.world.getBlockState(us1).getMaterial().isLiquid() && !mc.world.getBlockState(us2).getMaterial().isLiquid() && !mc.world.getBlockState(us3).getMaterial().isLiquid() && !mc.world.getBlockState(us1).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(us2).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(us3).getMaterial().equals(Material.POWDER_SNOW)){
                    mc.player.setPosition(mc.player.getX(),mc.player.getY()+spc.get(),mc.player.getZ()+1);}
                    else {}
                }
                case WEST -> {
                    ...
                    if (!mc.world.getBlockState(uw1).getMaterial().isSolid() && !mc.world.getBlockState(uw2).getMaterial().isSolid() && !mc.world.getBlockState(uw3).getMaterial().isSolid() && !mc.world.getBlockState(uw1).getMaterial().isLiquid() && !mc.world.getBlockState(uw2).getMaterial().isLiquid() && !mc.world.getBlockState(uw3).getMaterial().isLiquid() && !mc.world.getBlockState(uw1).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(uw2).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(uw3).getMaterial().equals(Material.POWDER_SNOW)){
                    mc.player.setPosition(mc.player.getX()-1,mc.player.getY()+spc.get(),mc.player.getZ());}
                    else {}
                }
                default -> {
