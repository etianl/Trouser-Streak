...
public class AutoMountain extends Module {
    ...
    private void cascadingpileof() {
        /*
         * I removed the "cascading pile of sh.."
         * It has been replaced with a single if-statement inside of a for-loop.
         * You're welcome.
         * Todo:
         *  - Create an ArrayList of acceptable materials then simply check if the item in hand is contained within that list.
         *
         */
        for(int i = 0; i <=8; i++)
        {
