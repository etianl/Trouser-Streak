...
public class AutoMountain extends Module {
    ...
    private void onMouseButton(MouseButtonEvent event) {
        if (mc.options.useKey.isPressed()){
            ...
            mc.player.setPos(mc.player.getX(),mc.player.getY()+0.2,mc.player.getZ());//this line here prevents you dying for realz
            mc.player.setVelocity(0,0.1,0);}//this line here prevents you dying for realz
            else if (adeathonoff.get()){
                mc.player.setPos(mc.player.getX(),mc.player.getY()+0.1,mc.player.getZ());//this line here prevents you dying for realz
                mc.player.setVelocity(0,0.1,0);}//this line here prevents you dying for realz
    ...
    private void onPreTick(TickEvent.Pre event) {
        ...
        if (mc.options.forwardKey.isPressed() && mc.options.rightKey.isPressed() && delayLeft <= 0 && offLeft > 0){
            cookie++;
        ...
        if (mc.options.forwardKey.isPressed() && mc.options.leftKey.isPressed() && delayLeft <= 0 && offLeft > 0){
            cookie++;
            if (cookie==munscher.get()){
                cookieyaw=mc.player.getYaw();
                mc.player.setYaw(mc.player.getYaw()-90);
        ...
        if (mc.options.backKey.isPressed() && mc.options.rightKey.isPressed() && delayLeft <= 0 && offLeft > 0){
            cookie++;
            if (cookie==munscher.get()){
                cookieyaw=mc.player.getYaw();
                mc.player.setYaw(mc.player.getYaw()+90);
        ...
        if (mc.options.backKey.isPressed() && mc.options.leftKey.isPressed() && delayLeft <= 0 && offLeft > 0){
            cookie++;
            if (cookie==munscher.get()){
                cookieyaw=mc.player.getYaw();
                mc.player.setYaw(mc.player.getYaw()-90);
