...
public class TrouserBuild extends TrouserModule {
    ...
    public TrouserBuild() {
        super("TrouserBuild", "Can build either horizontally and vertically according to a 5x5 grid centered on the block you are aiming at.");
    }
