...
public class ActivatedSpawnerDetector extends TrouserModule {
    ...
    public ActivatedSpawnerDetector() {
        super("ActivatedSpawnerDetector", "Detects if a player has been near a mob spawner in the past. May be useful for finding player made stashes in dungeons, mineshafts, and other places.");
    }
