...
public class AutoTitles extends Module {
    ...
    public void onActivate() {
        ...
        if (!notitlefrend.get()) {
            if (notitleself.get()){
                if (messageLengthExceedsLimit("/title @a[name=!" + mc.player.getName().getString() + "] title {\"text\":\"" + title.get() + "\", \"bold\":" + titlebold.get() + ", \"italic\":" + titleitalic.get() + ", \"color\":\"" + titlecolour.get() + "\"}")) {
                ...
                if (makesubtitle.get() && messageLengthExceedsLimit("/title @a[name=!" + mc.player.getName().getString() + "] subtitle {\"text\":\"" + subtitle.get() + "\", \"bold\":" + subtitlebold.get() + ", \"italic\":" + subtitleitalic.get() + ", \"color\":\"" + subtitlecolour.get() + "\"}")) {
                ...
                if (makeactionbar.get() && messageLengthExceedsLimit("/title @a[name=!" + mc.player.getName().getString() + "] actionbar {\"text\":\"" + actionbar.get() + "\", \"bold\":" + actionbarbold.get() + ", \"italic\":" + actionbaritalic.get() + ", \"color\":\"" + actionbarcolour.get() + "\"}")) {
