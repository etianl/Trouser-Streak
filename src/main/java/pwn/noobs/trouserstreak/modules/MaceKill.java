...
public class MaceKill extends Module {
    ...
    private void onSendPacket(PacketEvent.Send event) {
        if (mc.player != null && mc.player.getMainHandStack().getItem() == Items.MACE && event.packet instanceof IPlayerInteractEntityC2SPacket packet && packet.getType() == PlayerInteractEntityC2SPacket.InteractType.ATTACK) {
            try {
