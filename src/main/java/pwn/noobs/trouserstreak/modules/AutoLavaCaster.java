    ...
    private void autoposition() {
        ...
        if (mc.world.getBlockState(pos).getMaterial().isReplaceable()) {
                    if (aMountain.autocasttimenow==true && aMountain.wasfacing==Direction.EAST|| aMountain.autocasttimenow==false && mc.player.getYaw()>=90 && mc.player.getYaw()<=180 || tryanotherpos==true){ //NORTHWEST
                        BlockPos isair = new BlockPos (lava.getX()+2.5,lava.getY()+3,lava.getZ()+2.5);
                        BlockPos isair2 = new BlockPos (lava.getX()+2.5,lava.getY()+4,lava.getZ()+2.5);
                        ...
                        BlockPos isair = new BlockPos (lava.getX()-1.5,lava.getY()+3,lava.getZ()+2.5);
                        BlockPos isair2 = new BlockPos (lava.getX()-1.5,lava.getY()+4,lava.getZ()+2.5);
                        if (!mc.world.getBlockState(isair).getMaterial().isSolid() && !mc.world.getBlockState(isair).getMaterial().isLiquid() && !mc.world.getBlockState(isair).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(isair2).getMaterial().isSolid() && !mc.world.getBlockState(isair2).getMaterial().isLiquid() && !mc.world.getBlockState(isair2).getMaterial().equals(Material.POWDER_SNOW)) {
                        ...
                        BlockPos isair = new BlockPos (lava.getX()-1.5,lava.getY()+3,lava.getZ()-1.5);
                        BlockPos isair2 = new BlockPos (lava.getX()-1.5,lava.getY()+4,lava.getZ()-1.5);
                        if (!mc.world.getBlockState(isair).getMaterial().isSolid() && !mc.world.getBlockState(isair).getMaterial().isLiquid() && !mc.world.getBlockState(isair).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(isair2).getMaterial().isSolid() && !mc.world.getBlockState(isair2).getMaterial().isLiquid() && !mc.world.getBlockState(isair2).getMaterial().equals(Material.POWDER_SNOW)) {
                        ...
                        BlockPos isair = new BlockPos (lava.getX()+2.5,lava.getY()+3,lava.getZ()-1.5);
                        BlockPos isair2 = new BlockPos (lava.getX()+2.5,lava.getY()+4,lava.getZ()-1.5);
                        if (!mc.world.getBlockState(isair).getMaterial().isSolid() && !mc.world.getBlockState(isair).getMaterial().isLiquid() && !mc.world.getBlockState(isair).getMaterial().equals(Material.POWDER_SNOW) && !mc.world.getBlockState(isair2).getMaterial().isSolid() && !mc.world.getBlockState(isair2).getMaterial().isLiquid() && !mc.world.getBlockState(isair2).getMaterial().equals(Material.POWDER_SNOW)) {
