...
public class AutoLavaCaster extends TrouserModule {
    ...
    public AutoLavaCaster() {
        super("AutoLavaCaster", "Make Layers of Cobble on your Stairs! Aim at the top of the block you want to lava on.");
    }
