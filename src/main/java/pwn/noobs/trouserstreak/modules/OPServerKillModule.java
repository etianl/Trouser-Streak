...
public class OPServerKillModule extends TrouserModule {
    ...
    public OPServerKillModule() {
        super("OPServerKillModule", "Runs a set of commands to disable a server. Requires OP. (ONLY USE IF YOU'RE 100% SURE)");
    }
