...
- **InstaKill** Shoots arrows and tridents with incredible power and velocity. Credits to Saturn5Vfive. Disable extra "MovePacket" buttons in the inventory to choose how many to send. I couldn't change the default from them all being enabled and they all add up.
